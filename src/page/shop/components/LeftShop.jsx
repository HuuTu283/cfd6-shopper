...
export default function LeftShop() {
    let { category, loadingCategories } = useSelector(store => store.productReducer)
    return (
                            ...
                            <div className="form-group">
                                <ul className="list-styled mb-0" id="productsNav">
                                    <li className="list-styled-item">
                                        <NavLink exact className="list-styled-link" to="/cua-hang">
                                            All
                                        </NavLink>
                                    </li>

                                    {
                                        loadingCategories && [...Array(15)].map((e) => <Skeleton height={40} />)
                                    }
...

                                    {
                                        category.map((value) =>
                                            <li className="list-styled-item">
                                                <NavLink className="list-styled-link" to={`/cua-hang?categories=${value.id}`}>
                                                    {value.title}
                                                </NavLink>
                                            </li>)
                                    }
