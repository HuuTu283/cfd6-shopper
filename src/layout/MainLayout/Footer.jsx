                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-3">
                            {/* Heading */}
                            <h4 className="mb-6 text-white">{t('Shopper')}.</h4>
                            {/* Social */}
                        ...
                        <div className="col-6 col-sm">
                            ...
                            <ul className="list-unstyled mb-7 mb-sm-0">
                                <li>
                                    <a className="text-gray-300" href="./contact-us.html">{t('Contact Us')}</a>
                                </li>
                                <li>
                                    <a className="text-gray-300" href="./faq.html">{t('FAQs')}</a>
                                </li>
                                <li>
                                    <a className="text-gray-300" data-toggle="modal" href="#modalSizeChart">{t('Size Guide')}</a>
                                </li>
                                <li>
                                    <a className="text-gray-300" href="./shipping-and-returns.html">{t('Shipping & Returns')}</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-6 col-sm">
                            ...
                            <ul className="list-unstyled mb-7 mb-sm-0">
                                <li>
                                    <a className="text-gray-300" href="./shop.html">{t("Men's Shopping")}</a>
                                </li>
                                <li>
                                    <a className="text-gray-300" href="./shop.html">{t("Women's Shopping")}</a>
                                </li>
                                <li>
                                    <a className="text-gray-300" href="./shop.html">{t("Kids' Shopping")}</a>
                                </li>
                                <li>
                                    <a className="text-gray-300" href="./shop.html">{t('Discounts')}</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-6 col-sm">
                            ...
                            <ul className="list-unstyled mb-0">
                                <li>
                                    <a className="text-gray-300" href="./about.html">{t('Our Story')}</a>
                                </li>
                                <li>
                                    <a className="text-gray-300" href="#!">{t('Careers')}</a>
                                </li>
                                <li>
                                    <a className="text-gray-300" href="#!">{t('Terms & Conditions')}</a>
                                </li>
                                <li>
                                    <a className="text-gray-300" href="#!">{t('Privacy & Cookie policy')}</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-6 col-sm">
                            ...
                            <ul className="list-unstyled mb-0">
                                ...
                                <li>
                                    <a className="text-gray-300" href="#!">{t('help@shopper.com')}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
